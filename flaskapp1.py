...
def livestream():
    return Response(generate_frames(path_x = "https://www.youtube.com/live/LKse2ijG6QE?si=fEmxeHM1oWKnQM98"),mimetype='multipart/x-mixed-replace; boundary=frame')
